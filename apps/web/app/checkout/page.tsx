      ...
      <div className="mx-auto grid max-w-3xl gap-6 px-4 py-10 sm:px-6 md:px-8">
        <header className="space-y-3">
          ...
          <p className="max-w-[70ch] text-sm text-gray-600 dark:text-brisa-300 sm:text-base">
            ...
            el equipo operativo. Configura tus claves modo test y usa las
            tarjetas de prueba documentadas para validar el webhook y la
        ...
        <CheckoutClient services={services} publishableKey={publishableKey} />
      </div>
    </main>
  );
}
