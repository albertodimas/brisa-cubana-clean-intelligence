...
- Observabilidad verificada manualmente el 21-oct-2025 (evento Sentry `ec904a19-899c-4e91-9386-8304c02cd724`, PostHog `checkout_payment_failed`) y revalidada el 29-oct-2025 con `pnpm sentry:test-event` (evento `837b733d-aa58-4974-ac09-5b4afd80c2d7`) y `pnpm posthog:test-event` (distinct `brisa-cli-fbefa632-7836-472f-a047-427472b85e94`) tras sanitizar hosts.
