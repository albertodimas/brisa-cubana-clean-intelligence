...
- Dominios productivos: `https://brisacubanacleanintelligence.com` (landing + portal, incluye alias `app.brisacubanacleanintelligence.com`) y `https://api.brisacubanacleanintelligence.com`. Se conservarán hasta definir un dominio adicional si es necesario.
...
- Salud: `/health` sigue comprobando DB, Stripe (modo test) y SMTP; `/healthz` protegido por token opcional. Verificado 21-nov-2025: `app.brisacubanacleanintelligence.com` y `api.brisacubanacleanintelligence.com` responden 200.
...
### Últimos checks locales (21-nov-2025 03:00 UTC)

<!-- STATUS:AUTOGENERATED -->

> **Resumen vigente (17/11/2025, 07:38:02 UTC)**
>
> - Último deployment: Configura `VERCEL_ACCESS_TOKEN` y `VERCEL_PROJECT_ID` para consultar deployments.
> - Últimos runs CI:
>   • PostHog Checkout Monitor: queued/pendiente (17/11/2025, 07:38:01 UTC) – https://github.com/albertodimas/brisa-cubana-clean-intelligence/actions/runs/19421990671
>   • CI (Main Branch): in_progress/pendiente (17/11/2025, 07:37:27 UTC) – https://github.com/albertodimas/brisa-cubana-clean-intelligence/actions/runs/19421978482
>   • CodeQL: in_progress/pendiente (17/11/2025, 07:37:27 UTC) – https://github.com/albertodimas/brisa-cubana-clean-intelligence/actions/runs/19421978433
>   • Dependency Review: completed/success (17/11/2025, 07:37:17 UTC) – https://github.com/albertodimas/brisa-cubana-clean-intelligence/actions/runs/19421975191
>   • Vercel Preview Deployment: in_progress/pendiente (17/11/2025, 07:37:17 UTC) – https://github.com/albertodimas/brisa-cubana-clean-intelligence/actions/runs/19421975186
> - Generado con `node scripts/status/generate.mjs`

<!-- STATUS:AUTOGENERATED END -->
