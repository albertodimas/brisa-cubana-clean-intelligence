...
| Producto            | [`product/user-management.md`](product/user-management.md) · [`product/pagination.md`](product/pagination.md) · [`product/phase-2-roadmap.md`](product/phase-2-roadmap.md)                                                                                                                                                                                                                               | Definición funcional actual y plan de Fase 2 (landing, checkout, portal cliente) con criterios listos para desarrollar. |
