...
| **Fase 5** (diferida Q1 2026)               | Tailwind 4.x               | Investigación de breaking changes, generar design tokens equivalentes, ajustar build (PostCSS), validar UI manualmente.                       |
