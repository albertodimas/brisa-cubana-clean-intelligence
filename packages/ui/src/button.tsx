...
export function Button(props: ButtonProps) {
  ...
  const palettes: Record<Intent, string> = {
    ...
    ghost:
      "bg-transparent text-neutral-100 hover:bg-white/10 focus-visible:outline-neutral-200",
  };

  if (props.as === "a") {
    const { as: anchorTag, ...rest } = props as AnchorButtonProps;
    void anchorTag;
    return (
  ...
  const { as: buttonTag, ...rest } = props as NativeButtonProps;
  void buttonTag;
  return (
