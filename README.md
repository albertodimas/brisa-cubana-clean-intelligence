...
| One-pager SaaS    | [`docs/product/one-pager.md`](docs/product/one-pager.md) · [Versión web](https://brisacubanacleanintelligence.com/recursos/one-pager)                                                          | Resumen comercial descargable + CTA al formulario de interés.                         |
